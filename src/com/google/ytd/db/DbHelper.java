...
public class DbHelper {
  ...
  public static final String PLAYLISTID = "p_id";
  public static final String TITLE = "title";
  public static final String INSTRUCTIONS = "loginInstruction";
  ...
  private static final String DATABASE_CREATE = "create table " + DATABASE_TABLE + " (" + KEY_ID
      ...
      + UPDATED + " text not null," + CREATED + " text not null," + TITLE + " text not null," + PLAYLISTID   +  " text," + INSTRUCTIONS + " text)";
  ...
  public Assignment getAssignment(String id) {
    Cursor cursor = db.query(true, DATABASE_TABLE, new String[] { KEY_ID, YTD_DOMAIN,
        ASSIGNMENT_ID, STATUS, CREATED, UPDATED, DESCRIPTION, PLAYLISTID, INSTRUCTIONS, TITLE }, KEY_ID + "=" + id, null, null,
        null, null, null);
    ...
    assignment.setPlaylistId(cursor.getString(cursor.getColumnIndex(PLAYLISTID)));
    assignment.setInstructions(cursor.getString(cursor.getColumnIndex(INSTRUCTIONS)));
    assignment.setTitle(cursor.getString(cursor.getColumnIndex(TITLE)));
  ...
  public Assignment getAssignment(String ytdDomain, String assignmentId) {
    Cursor cursor = db.query(true, DATABASE_TABLE, new String[] { STATUS, CREATED, UPDATED,
        DESCRIPTION, PLAYLISTID, INSTRUCTIONS, TITLE }, ASSIGNMENT_ID + "=" + assignmentId + " AND " + YTD_DOMAIN + "=\""
  ...
  public List<Assignment> getAllAssignments(String ytdDomain) {
    ...
    Cursor cursor = db.query(true, DATABASE_TABLE, new String[] { ASSIGNMENT_ID, STATUS, CREATED,
        UPDATED, DESCRIPTION, PLAYLISTID, INSTRUCTIONS, TITLE },
  ...
  public Cursor getAllAssignmentsCursor(String ytdDomain) {
    return db.query(true, DATABASE_TABLE, new String[] { KEY_ID, ASSIGNMENT_ID, STATUS, CREATED,
        DESCRIPTION, PLAYLISTID, INSTRUCTIONS, TITLE }, YTD_DOMAIN + "=\"" + ytdDomain + "\" AND " + STATUS + "=\"ACTIVE\"", null,
  ...
  public long insertAssignment(Assignment assignment) {
    ...
    values.put(PLAYLISTID, assignment.getPlaylistId());
    values.put(INSTRUCTIONS, assignment.getInstructions());

...
public class Assignment {
	...
	public String toString() {
		return "Assignment [assignmentId=" + assignmentId + ", ytdDomain="
				+ ytdDomain + ", status=" + status + ", description="
				+ description + ", instructions=" + instructions
				+ ", playlistId=" + playlistId + ", created=" + created
				+ ", updated=" + updated + ", isHeading=" + isHeading + "]";
	}
